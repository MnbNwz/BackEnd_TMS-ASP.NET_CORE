...
namespace tms.Server.Migrations
{
    ...
    [Migration("20240521063024_role1Removed")]
    partial class role1Removed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("tms.Server.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Admin Jani",
                            PasswordHash = "AQAAAAIAAYagAAAAEPjuz6GmiXeH7ExlNUZIBaV/BLieYU0cPkyzKpxYrXC2nclSR4eS/pq6tzjLK5i3vw==",
                            Role = 1
                        });
                });
